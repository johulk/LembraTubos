...
class ServicoAdapter(
    ...
    override fun onBindViewHolder(holder: ServicoViewHolder, position: Int) {
        ...
        holder.bindServicoItem(clienteWithServicos.servicos[servicoIndex], clienteWithServicos.cliente)

        holder.itemView.setOnClickListener {
            navController = parentFragment.findNavController()
            // Use the Servico object directly here for navigation or other actions
            val direction = LibraryFragmentDirections.actionGlobalDetalhesServico(clienteWithServicos.cliente, clienteWithServicos.servicos[servicoIndex])
